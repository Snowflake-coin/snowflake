...
// Copyright (c) 2021, The Snowflake Developers
//
...
namespace CryptoNote
{
  ...
  {
    const uint64_t DIFFICULTY_TARGET                                       = 150;                             // 150 seconds (2.5 minutes) block time
    const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX                 = 0x1d1717;                        // SNW
    ...
    const uint64_t MONEY_SUPPLY                                            = UINT64_C(15'000'000'00000000);   // 15 million SNW
    const uint64_t BLOCK_REWARD                                            = UINT64_C(1'00000000);            // 1.00000000 SNW
    const uint64_t GENESIS_BLOCK_REWARD                                    = UINT64_C(225'000'00000000);      // 225,000 SNW (1.5%) Premine
    ...
    const char GENESIS_COINBASE_TX_HEX[] = 
      "010a01ff000180c2d72f029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101c0895039fc4db7f4546f55f522dc7f2c42e5d5d88c9f4e33f02281428d14c723";
    ...
    const uint64_t GENESIS_BLOCK_TIMESTAMP                                 = 1639685096;                    // 09:05 PM CEST, December 16 2021
    ...
    const uint64_t ACCEPTABLE_FEE                                          = UINT64_C(5000);     // with this fee, tx is always accepted whatever size - 0.00005000 SNW
    const uint64_t ACCEPTABLE_FEE_V1                                       = UINT64_C(5000);     // with this fee, tx is always accepted whatever size - 0.00005000 SNW
    ...
    /* 15,000,000 SNW -> Max supply / mixin+1 outputs                 */
    /* This is enforced on the daemon side. An output > 15,000,000 causes an invalid block.   */
    const uint64_t MAX_OUTPUT_SIZE_NODE                                    = 15'000'000'00000000;
  ...
  const char    CRYPTONOTE_NAME[]                                          = "Snowflake";
  ...
  const char LATEST_VERSION_URL[]                                          = "https://github.com/Snowflake-coin/snowflake/releases";
  ...
  const char *const SEED_NODES[] = {
    "62.171.158.41:22100", //S1
    "84.27.218.58:22100",  //T1
    "176.57.189.177:22100" //SE1
  };
}
